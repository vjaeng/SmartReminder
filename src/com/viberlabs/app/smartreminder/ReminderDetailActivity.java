...
/*		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.GINGERBREAD_MR1){ //.ECLAIR_MR1)
	        Log.d(this.getClass().getName().toString(), "Creando el ActionBar...");
			// Show the Up button in the action bar.
			getActionBar().setDisplayHomeAsUpEnabled(true);
		} else {
	        Log.d(this.getClass().getName().toString(), "Ignorando el ActionBar...");
		}*/
        // Show the Up button in the action bar:
